...
- [ ] 1.1 Em `src/styles/tokens.css`, adicionar um comentário-constante
...
- [ ] 2.1 Em `src/pages/ReviewSessionPage.css`, adicionar
      ...
      texto cortado.
- [ ] 2.2 Confirmar, nas mesmas ferramentas de dispositivo, em 481px e em
...
- [ ] 3.1 Em `src/pages/AddCardPage.css`, adicionar
...
- [ ] 3.2 Confirmar em 481px e em uma largura de desktop: Palavra e
      Tradução continuam lado a lado, igual a antes da mudança.
- [ ] 3.3 Confirmar que `.ms-field--full` (classe collada por
...
- [ ] 4.1 Rodar `npm run lint` e confirmar que passa sem erros novos.
- [ ] 4.2 Repetir a checagem visual dos itens 2.1 e 3.1 no tema claro e no
